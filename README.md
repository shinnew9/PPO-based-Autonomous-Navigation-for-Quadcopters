...
I git cloned from this [repository](https://github.com/bilalkabas/PPO-based-Autonomous-Navigation-for-Quadcopters) and detached the git remote. I will keep updating in scripts/airsim_env.py and policy_run.py 
